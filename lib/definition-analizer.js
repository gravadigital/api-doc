...
function decodeDeclaration(declaration) {
  ...
  data.description = extractDefaultTag(declaration, 'description', true);
  ...
  data.headerparams = exportParamTags(declaration, 'headerparam');
  data.urlparams = exportParamTags(declaration, 'urlparam');
